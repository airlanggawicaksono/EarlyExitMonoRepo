...
Training lives in GeneralizableSelfDistilationEarlyExitTraining/backends/llama;
this package holds data prep + benchmarks (ee/ keeps the inference/eval helpers).
"""
