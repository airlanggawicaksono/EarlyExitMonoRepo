...
def forward_remainder(
    ...
    for idx, decoder_layer in enumerate(model.model.layers):
        ...
        if is_early_exit:
            ...
            early_position_embeddings = _compute_position_embeddings(
                model, early_hidden_states, early_position_ids
            )
            ...
            full_position_embeddings = _compute_position_embeddings(
                model, full_hidden_states, position_ids
            )
